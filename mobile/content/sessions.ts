...
export const SESSIONS: Session[] = [
    ...
    },
    {
        ...
        difficulty: 'moderate',
        trigger: 'loud_noises',
        goal: 'Help the owner prepare a calmer environment and practice low-pressure routines before predictable noisy events.',
        beforeYouStart: [
            'Use this before expected fireworks, not during panic.',
            'Start with very easy steps.',
            'Keep the dog below their fear threshold.',
        ...
        steps: [
            ...
            },
            {
                ...
                instruction: 'If available, play a gentle background sound at low volume. Stop if your dog seems worried.',
                durationSeconds: 60,
                visualCue: 'pulse',
                canSkip: true
            },
