...
describe('Premium Routines Data Integrity', () => {
    ...
    test('all 6 premium routines exist', () => {
        const expectedIds = ['fireworks_prep_routine', 'visitors_at_home', 'being_alone', 'vet_visit_prep', 'outdoor_confidence_reset', 'post_fireworks_walk_rebuild'];
